...
p "repl_negative_to_max [1,2,-3,4,5,-6,7]"
...
p "sort_cba [1,2,-3,4,5,-6,7]"
def sort_cba (arr)
	
	p arr.sort {|x, y| y <=> x }
end
sort_cba [1,2,-3,4,5,-6,7]
p '--------------'
...
p "even_plus_last_elem [1,-20,60,4,-5,60,-50]"
...
odd_plus_last_elem [1,-20,60,4,-5,60,-50]
p '--------------'
...
p "odd_plus_first_elem [1,-20,60,4,-5,60,-50]"
...
odd_plus_first_elem [1,-20,60,4,-5,60,-50]
p '--------------'